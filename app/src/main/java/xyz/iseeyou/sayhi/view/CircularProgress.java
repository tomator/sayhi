...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[3] = context.getResources().getColor(R.color.md_red_500);
        mColors[2] = context.getResources().getColor(R.color.md_yellow_500);
        mColors[0] = context.getResources().getColor(R.color.md_green_500);
        mColors[1] = context.getResources().getColor(R.color.md_light_blue_500);
